...
namespace RTF {
    namespace Math{
        ...
        SVector2::SVector2() : Vector2<Strings::SharedString>(Strings::SharedString(""), Strings::SharedString("")) {};
        SVector2::SVector2(Strings::SharedString x, Strings::SharedString y): Vector2<Strings::SharedString>(std::move(x), std::move(y)) {};


        SVector3::SVector3(): Vector3<Strings::SharedString>(Strings::SharedString(""), Strings::SharedString(""), Strings::SharedString("")){};
        SVector3::SVector3(Strings::SharedString x, Strings::SharedString y, Strings::SharedString z): Vector3<Strings::SharedString>(std::move(x), std::move(y), std::move(z)) {}


        SVector4::SVector4(): Vector4<Strings::SharedString>(Strings::SharedString(""), Strings::SharedString(""), Strings::SharedString(""), Strings::SharedString("")){};
        SVector4::SVector4(Strings::SharedString x, Strings::SharedString y, Strings::SharedString z, Strings::SharedString s): Vector4<Strings::SharedString>(std::move(x), std::move(y), std::move(z), std::move(s)) {}
